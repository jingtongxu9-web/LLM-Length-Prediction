"""Run checks and irreversibly open the Hybrid v3 final-Test phase."""
...
from llm_length_prediction.hybrid_experiment import load_hybrid_config
...
def main() -> None:
    ...
    if not args.confirm_final_test:
        raise SystemExit("refusing to open final Test without --confirm-final-test")
    ...
    print(f"FINAL TEST OPENED ONCE at {marker['opened_at_utc']}")
